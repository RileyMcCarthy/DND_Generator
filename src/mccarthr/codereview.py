...
startcount = 0
startdescription = 0
regex = ["public", "private", "static", "void", "int", "String", "boolean", "ArrayList<Treasure>", "ArrayList<Door>", "ArrayList<Monster>", "{"]
...
while (loop == "yes"):
    ...
    for lines in file:
        ...
        if "}" in line and brackcount == 1:
            ...
            writer.writerow([method, description, instancevars, classmethods, othermethods, linecount - 2])
            method = ""
            description = ""
            othermethods = ""
            classmethods = ""
